...
const footerLinks = {
    ...
    Languages: [
        { label: 'HTML', href: '/docs/html' },
        { label: 'CSS', href: '/docs/css' },
    ...
    return (
        <footer className="relative border-t border-white/10 bg-[#0F172A] text-white overflow-hidden">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
                {/* Main footer content */}
                <div className="pt-14 pb-10 grid grid-cols-2 sm:grid-cols-4 gap-10">
                    {/* Brand column */}
                    <div className="col-span-2 sm:col-span-1">
                        <Link href="/" className="inline-flex items-center gap-2.5 mb-4">
                            <FooterLogo />
                            <span className="text-lg font-extrabold text-gradient">Spear</span>
                        </Link>
                        <p className="text-sm text-slate-400 leading-relaxed mb-5 max-w-[240px]">
                            Platform pembelajaran coding interaktif. Belajar web development dengan cara yang seru dan efektif.
                        </p>
                        {/* Social icons */}
                    ...
                    {Object.entries(footerLinks).map(([category, links]) => (
                        <div key={category}>
                            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-500 mb-4">{category}</h4>
